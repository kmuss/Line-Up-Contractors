...
<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "SELECT username, Password FROM ManagerLogIn WHERE username = '{$usernameFromForm}'";
  ...
  <div class="mx-auto" style="width: 400px;">
    <form action="managerlogin.php" method="POST">
      ...
      <label for="exampleInputemail">Username</label>
        <input type="text"  class="form-control" placeholder="Enter your username" name="username" class="form-control" required>
        </div>
      <div class="form-group">
